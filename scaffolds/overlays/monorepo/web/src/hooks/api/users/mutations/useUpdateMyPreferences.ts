 ...
 * Dependencies
 */
import { userControllerUpdateMyPreferences } from '@{{PROJECT_NAME}}/api-client/generated/api/users/users'
...
export const useUpdateMyPreferences = () => {
  ...
  const mutation = useMutation({
    ...
    mutationFn: async (data: UpdateMyPreferencesPayloadDto) => {
      ...
      const response = await userControllerUpdateMyPreferences(payload)
