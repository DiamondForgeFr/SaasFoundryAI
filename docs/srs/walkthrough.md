...
New to the model? Start with [One source of truth for product requirements](/srs/centralization) to understand what remains in Notion, what the agent may propose, and where explicit approval is
required.
