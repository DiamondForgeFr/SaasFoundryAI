 ...
 * changes.
 */
export const configSteps: StepDefinition[] = [profileStep, projectStep, harnessProjectStep, emailCredentialsStep, storageStep, analyticsStep, pwaStep, toolsStep, workflowStep, skillsStep, srsStep]
