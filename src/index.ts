...
program
  ...
  .option('--add-modules <modules>', 'Comma-separated list of modules to add (email, storage, analytics, sf-skill-context7, sf-skill-atlassian, sf-skill-notion, sf-skill-figma)')
